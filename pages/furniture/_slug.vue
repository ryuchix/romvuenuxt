            ...
            <dl
              ...
              <dd class="single-row">
                ...
                <nuxt-link
                  ...
                  :to="{ name: 'furniture-slug', params: { slug: equipment.item_from['slug'] }}">{{ equipment.item_from['name_en'] }}</nuxt-link>
                <nuxt-link
                  v-if="equipment.item_from['type_name'] == 'Furniture Blueprint'"
            ...
            <dl v-if="equipment.compose_output_id != null && equipment.item_to != null">
              ...
              <dd class="single-row">
                ...
                <nuxt-link
                  ...
                  :to="{ name: 'furniture-slug', params: { slug: equipment.item_to['slug'] }}">{{ equipment.item_to['name_en'] }}</nuxt-link>
                <nuxt-link
                  v-if="equipment.item_to['type_name'] == 'Furniture Blueprint'"
                  ...
                  <div v-for="equip in synth.materials" :key="equip.id">
                    ...
                    <div class="item-info">
                        ...
                        <nuxt-link :to="{ name: 'item-slug', params: { slug: 'zeny' }}" style="line-height: 1.2em; display: flex;">
                            <div class="item-name" @click="$router.push({name: 'item-slug', params: { slug: 'zeny' }})">
...
export default {
  ...
  async fetch() {
    await axios
    .get(constant.getFurniture + this.slug)
    .then(response => (this.equipment = response.data))
    .finally(() => this.loading = false)
  },
  fetchOnServer: true,
